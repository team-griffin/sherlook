...
declare module ramda {
  ...
  // declare function chain<T, R>(fn: (x: T) => Monad, xs: Monad): Monad;
  // declare function chain<T, R>(fn: (x: T) => Monad, ...rest: Array<void>): (xs: Monad) => Monad;
  declare function chain<M: { chain: Function }, T>(fn: (x: T) => M, xs: M): M;
  declare function chain <M: { chain: Function }, T>(fn: (x: T) => M, ...rest: Array<void>): (xs: M) => M;
